...
class _AddMaterialsScreenState extends State<AddMaterialsScreen> {
  ...
  // ── Cálculos ─────────────────────────────────────────────────
  double get _materialsCost => _materials.fold(0.0, (s, m) => s + m.actualCost);
  ...
  void initState() {
    super.initState();
    _profitExtra =
        widget.product.suggestedPrice != null &&
            widget.product.totalCost != null
        ? (widget.product.suggestedPrice! - widget.product.totalCost!).clamp(
            0,
            double.infinity,
          )
        : 0;
  ...
  Future<void> _loadMaterials() async {
    ...
    try {
      ...
      _err('Error al cargar materiales');
    } finally {
      ...
      await _repo.addMaterial(
        MaterialItem(
          ...
          purchaseCost: double.parse(
            _purchaseCostCtrl.text.replaceAll(',', '.'),
          ),
          usedQty: usedQty,
          usedUnit: _usedUnit,
        ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _SubLabel(
                      ...
                      text: '¿Cuánto compraste y cuánto pagaste?',
                    ),
                    ...
                    _SubLabel(
                      ...
                      text: '¿Cuánto vas a usar en este producto?',
                    ),
                    const SizedBox(height: 8),
            ...
            _SectionCard(
              title: 'Materiales del producto (${_materials.length})',
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '$_sym ${_materialsCost.toStringAsFixed(2)}',
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: const Color(0xFF6B6BE8).withOpacity(0.25),
                      ),
                    ),
                    child: Row(
                      children: [
                        ...
                        Text(
                          '$_sym ${_laborCost.toStringAsFixed(2)}',
                          style: const TextStyle(
                            fontSize: 17,
            ...
            // ══ 4. GANANCIA EXTRA ══════════════════════════════
            _SectionCard(
              title: '¿Cuánto quieres ganar extra?',
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Slider(
                          value: _profitExtra.clamp(
                            0,
                            (_totalCost * 3).clamp(1, double.infinity),
                          ),
                          min: 0,
                      ...
                      Container(
                        ...
                        child: Text(
                          '$_sym ${_profitExtra.toStringAsFixed(2)}',
            ...
            CustomButton(
              ...
              onPressed: () async {
                await _syncCosts();
                _ok('Costeo guardado correctamente');
              },
              isAccent: true,
            ),
    ...
    child: Column(
      ...
      children: [
        ...
        _SRow(
          ...
          value: '$symbol ${materialsCost.toStringAsFixed(2)}',
        ),
        const SizedBox(height: 10),
        _SRow(
          icon: Icons.engineering_outlined,
          iconColor: const Color(0xFF6B6BE8),
          label: 'Mano de obra (tu tiempo)',
          value: '$symbol ${laborCost.toStringAsFixed(2)}',
        ),
        const Padding(
        ...
        _SRow(
          ...
          value: '$symbol ${totalCost.toStringAsFixed(2)}',
          bold: true,
        ...
        if (profitExtra > 0) ...[
          _SRow(
            ...
            value: '+$symbol ${profitExtra.toStringAsFixed(2)}',
            bold: true,
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Text(
                '$symbol ${suggestedPrice.toStringAsFixed(2)}',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 24,
                  fontWeight: FontWeight.w800,
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(
              'Este material no afecta el costo — se registra como referencia',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _PRow(
            'Compraste',
            '${item.purchaseQty} ${item.purchaseUnit}  →  $symbol ${item.purchaseCost.toStringAsFixed(2)}',
          ),
          const SizedBox(height: 4),
          _PRow(
            'Vas a usar',
            '${item.usedQty} ${item.usedUnit}  (${pct.toStringAsFixed(0)}% del total)',
          ),
          const Padding(
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '$symbol ${item.actualCost.toStringAsFixed(2)}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w800,
                  color: AppColors.primary,
