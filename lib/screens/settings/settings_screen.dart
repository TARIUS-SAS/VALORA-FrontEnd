...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _changeCountry() async {
    final country = await Navigator.push<Country>(
      ...
      MaterialPageRoute(
        builder: (_) =>
            _CountryPickerScreen(selected: countryByCode(_auth.countryCode)),
      ),
    );
    if (country != null) {
  ...
  Future<void> _editMinWage() async {
    final ctrl = TextEditingController(
      text: _auth.minWagePerHour.toStringAsFixed(2),
    );
    final result = await showDialog<String>(
      context: context,
      builder: (_) => AlertDialog(
      ...
      body: ListView(
        ...
        children: [
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    child: Text(
                      _auth.fullName.isNotEmpty
                          ? _auth.fullName[0].toUpperCase()
                          : 'U',
                      style: const TextStyle(
                        fontSize: 22,
          ...
          _SettingsTile(
            ...
            subtitle:
                '${_auth.countryFlag} ${_auth.countryName} · ${_auth.currencyName}',
          ...
          _SettingsTile(
            ...
            subtitle:
                '${_auth.currencySymbol} ${_auth.minWagePerHour.toStringAsFixed(2)} / hora',
            onTap: _editMinWage,
          ),
